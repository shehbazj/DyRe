...
arg(maxredundancy_ARG, '\0', "maxredundancy", int_arg, 0)
...
arg(minredundancy_ARG, '\0', "minredundancy", int_arg, 0)
...
arg(dyremaxredundancy_ARG, '\0', "dyreminredundancy", int_arg, 0)
arg(dyreminredundancy_ARG, '\0', "dyremaxredundancy", int_arg, 0)
...
arg(udgrade_ARG, 'x', "udgrade", string_arg, 0)
