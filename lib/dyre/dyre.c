...
/*
	...
	.add_target_line = _dyre_add_target_line,
	.target_status_compatible = _dyre_target_status_compatible,
#ifdef DEVMAPPER_SUPPORT
	.target_percent = _dyre_target_percent,
	.target_present = _dyre_target_present,
	.modules_needed = _dyre_modules_needed,
#  ifdef DMEVENTD
	.target_monitored = _dyre_target_monitored,
	.target_monitor_events = _dyre_target_monitor_events,
	.target_unmonitor_events = _dyre_target_unmonitor_events,
#  endif        // DMEVENTD /
#endif
